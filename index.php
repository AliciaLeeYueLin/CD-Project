 ...
 <section> 
     <nav class="navbar navbar-expand-lg fixed-top">
        ...
        <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item"><a class="nav-link p-2 text-white" href="login-form.php">Log In</a></li>
                        <li class="nav-item"><a class="nav-link p-2 text-white" href="registration-form.php">Sign Up</a></li>
