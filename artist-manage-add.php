...
<body>
    <div class="card">
        ...
        <h1>' . ($message) . '</h1>
        <hr>
<a href="artist-manage.php" class="btn-back">OK</a>
</div>
</div>
</body>
</html>';
    ...
    <div class="container mx-auto my-5" style="max-width: 700px;">
      ...
      <div class="card mb-2 p-4">
        ...
        <input type="hidden" name="post_by" value="1">
          <div class="text-end">
            <a href="artist-manage.php"><button type="submit" class="btn btn-add btn-primary">Add</button></a>
          </div>
        </form>
      </div>
      <div class="text-center">
        <a href="artist-manage.php" class="btn btn-back btn-link btn-sm"
